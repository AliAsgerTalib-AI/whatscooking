...
import type { AllergenStatus } from "../types/recipe";
  ...
  return (
    <div className="mt-6">
      ...
      <div className="flex gap-4 flex-wrap mb-3">
        {([
          ["bg-primary",              "Contains"],
          ["bg-surface-container",    "May contain"],
          ["bg-surface border border-primary", "Not present"],
          ...
          <div key={label} className="flex items-center gap-2 text-label-sm">
            ...
            <span className="uppercase tracking-label">{label}</span>
          </div>
        ))}
      </div>
